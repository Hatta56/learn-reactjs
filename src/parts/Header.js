          ...
          <div className="w-auto">
            ...
            >
              <li className="mx-3 py-6 md:py-0">
                <Link to="/showcase" className={["hover:underline", theme === "white" ? "text-[#000] md:text-[#fff]": "text-[#fff] md:text-[#000] "].join(" ")}>
                  Showcase
                </Link>
              </li>
              <li className="mx-3 py-6 md:py-0">
                <Link to="/catalog" className={["hover:underline", theme === "white" ? "text-[#000] md:text-[#fff]": "text-[#fff] md:text-[#000] "].join(" ")}>
                  Catalog
                </Link>
              </li>
              <li className="mx-3 py-6 md:py-0">
                <Link to="/deliver" className={["hover:underline", theme === "white" ? "text-[#000] md:text-[#fff]": "text-[#fff] md:text-[#000] "].join(" ")}>
                  Deliver
                </Link>
              </li>
              <li className="mx-3 py-6 md:py-0">
                <Link to="/reward" className={["hover:underline", theme === "white" ? "text-[#000] md:text-[#fff]": "text-[#fff] md:text-[#000] "].join(" ")}>
                  Rewards
                </Link>
              </li>
            </ul>
