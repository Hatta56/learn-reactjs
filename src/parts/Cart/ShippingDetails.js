              ...
              <form action="success.html">
                ...
                <div className="flex flex-col mb-4">
                  ...
                  <input
                    ...
                    type="text"
                    id="complete-name"
                    className="border-gray-200 border rounded-lg px-4 py-2 bg-[#fff] text-sm focus:border-blue-200 focus:outline-none"
                  ...
                  <div className="flex -mx-2 flex-wrap">
                    <div className="px-2 w-6/12 h-24 mb-4">
                      <button
                        ...
                        data-value="fedex"
                        data-name="courier"
                        className="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-[#fff] w-full h-full focus:outline-none"
                      >
                        <img
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    disabled
                    className="bg-pink-400 text-black hover:bg-[#000] hover:text-pink-400 focus:outline-none w-full py-3 rounded-full text-lg focus:text-black transition-all duration-200 px-6"
                  >
                    Checkout Now
                  </button>
                </div>
