    ...
    <div className="overflow-x-hidden px-4" id="carousel">
      ...
      <div className="flex -mx-4 flex-row relative">
        ...
        <div className="px-4 relative card group">
          ...
          >
            <div className="absolute opacity-0 group-hover:opacity-100 transition duration-200 flex items-center justify-center w-full h-full bg-[#000] bg-opacity-35">
              <div className="bg-[#ffff] text-black rounded-full w-16 h-16 flex items-center justify-center" >
                <svg
        ...
        <div className="px-4 relative card group">
          ...
          >
            <div
              className="absolute opacity-0 group-hover:opacity-100 transition duration-200 flex items-center justify-center w-full h-full bg-[#000] bg-opacity-35"
            >
              <div
                className="bg-[#ffff] text-black rounded-full w-16 h-16 flex items-center justify-center"
              >
                <svg
                  className="fill-current"
                  width="43"
